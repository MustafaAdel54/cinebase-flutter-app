...
String _$movieDetailsHash() => r'c022381ec2de18aecf6a052757cd835f111bae59';
...
/// See also [movieDetails].
class MovieDetailsFamily extends Family<AsyncValue<MovieModel?>> {
  /// See also [movieDetails].
  const MovieDetailsFamily();

  /// See also [movieDetails].
  MovieDetailsProvider call(String id) {
...
/// See also [movieDetails].
class MovieDetailsProvider extends AutoDisposeFutureProvider<MovieModel?> {
  /// See also [movieDetails].
  MovieDetailsProvider(String id)
    : this._internal(
        (ref) => movieDetails(ref as MovieDetailsRef, id),
  ...
  Override overrideWith(
    FutureOr<MovieModel?> Function(MovieDetailsRef provider) create,
  ) {
...
mixin MovieDetailsRef on AutoDisposeFutureProviderRef<MovieModel?> {
...
class _MovieDetailsProviderElement
  ...
  @override
  String get id => (origin as MovieDetailsProvider).id;
}
